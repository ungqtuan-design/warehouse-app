  ...
  return (
    <section className="rounded-2xl border border-slate-200 bg-white p-6 shadow-sm">
      <div>
        ...
        <h1 className="mt-1 text-xl font-semibold text-slate-950">{text.multiLineForm}</h1>
      </div>
      ...
      <div className="mt-8">
        <div>
          ...
          <h2 className="mt-1 text-lg font-semibold text-slate-950">{text.inboundHistory}</h2>
        </div>
