  ...
  return (
    <>
      ...
      <div className="mt-5 overflow-x-auto rounded-2xl border border-slate-200">
        <table className="min-w-[1100px] divide-y divide-slate-200 text-left text-sm lg:min-w-full">
                    ...
                    <div className="grid gap-2">
                      <button
                        ...
                        onClick={() => {
                          ...
                          setMessages((current) => ({
                            ...current,
                            [product.id]: result.ok ? text.addedToBasketMessage : (result.message === "exceeds-stock" ? text.exceedsStockMessage : text.inactiveProductMessage),
                          }));
